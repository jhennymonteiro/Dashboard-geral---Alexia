...
async function startServer() {
  ...
  let config = {
    sheetUrl: 'https://docs.google.com/spreadsheets/d/1IocSgvf5un9E6LCF6DrpCWn8Hg6ZlJpaWJNFX_MKzrE/edit?gid=0#gid=0',
    spreadsheetId: '1IocSgvf5un9E6LCF6DrpCWn8Hg6ZlJpaWJNFX_MKzrE',
    sheetName: 'Sheet1',
    appsScriptUrl: '',
    autoSync: true,
  ...
  app.post('/api/leads', (req, res) => {
    const servico = req.body.servico || req.body.queixaCliente || 'Não informado';
    const newLead: Lead = {
      id: `lead-${Date.now()}`,
